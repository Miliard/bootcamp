                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action=" {{ route('chirps.store') }}">
                        ...
                        <textarea name="message"
                            ...
                            placeholder=" Q estas pensado?? ">{{ old('message') }}</textarea>
                    ...
                    <div class="p-6 flex space-x-2">
                        ...
                        @can('update', $chirp)
                            ...
                            <x-dropdown>
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('chirps.edit', ['chirp' => $chirp])">
                                        {{ __('Edit Chirp') }}
                                    </x-dropdown-link>
                                    <form method="POST" action="{{ route('chirps.destroy', $chirp) }}">
                                        @csrf @method('DELETE')

                                    <x-dropdown-link :href="route('chirps.destroy', ['chirp' => $chirp])" onclick="event.preventDefault(); this.closest('form').submit();" >
                                        {{ __('Delete Chirp') }}
                                    </x-dropdown-link>
